...
COPY ["Lakeshore.Common/Lakeshore.Common.csproj", "Lakeshore.Common/"]
COPY ["Lakeshore.Repository/Lakeshore.Repository.csproj", "Lakeshore.Repository/"]
COPY ["Lakeshore.Models/Lakeshore.Models.csproj", "Lakeshore.Models/"]
